...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.DELETE("/auth-pool/paths", s.mgmt.DeleteAuthPoolPath)
		mgmt.PUT("/auth-pool/current", s.mgmt.PutCurrentAuthPoolPath)
		mgmt.PATCH("/auth-pool/current", s.mgmt.PutCurrentAuthPoolPath)
		mgmt.PUT("/auth-pool/strategy", s.mgmt.PutAuthPoolStrategy)
		mgmt.PATCH("/auth-pool/strategy", s.mgmt.PutAuthPoolStrategy)
