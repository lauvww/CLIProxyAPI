...
const (
	defaultManagementReleaseURL  = "https://api.github.com/repos/lauvww/Cli-Proxy-API-Management-Center/releases/latest"
	defaultManagementFallbackURL = "https://cpamc.router-for.me/"
	managementAssetName          = "management.html"
	managementLocalBuildMarker   = "<!-- CLIProxyAPI local management build -->"
...
func EnsureLatestManagementHTML(ctx context.Context, staticDir string, proxyURL string, panelRepository string) bool {
	...
	if isLocalPublishedManagementHTML(localPath) {
		return true
	}
...
func isLocalPublishedManagementHTML(path string) bool {
	...
	return bytes.Contains(buf[:n], []byte(managementLocalBuildMarker))
}
